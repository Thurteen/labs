...
(cl:ensure-generic-function 'x_2dot-val :lambda-list '(m))
(cl:defmethod x_2dot-val ((m <DesiredStateMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aer1217_ardrone_simulator-msg:x_2dot-val is deprecated.  Use aer1217_ardrone_simulator-msg:x_2dot instead.")
  (x_2dot m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DesiredStateMsg>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'x_dot)))
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:aref vals i) (roslisp-utils:decode-double-float-bits bits)))))
  (cl:setf (cl:slot-value msg 'x_2dot) (cl:make-array 3))
  (cl:let ((vals (cl:slot-value msg 'x_2dot)))
    (cl:dotimes (i 3)
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DesiredStateMsg>)))
  ...
  "42fa4626d1775b5bbdc04cda38e22d9c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DesiredStateMsg)))
  "Returns md5sum for a message object of type 'DesiredStateMsg"
  "42fa4626d1775b5bbdc04cda38e22d9c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DesiredStateMsg>)))
  ...
  (cl:format cl:nil "# DesiredStateMsg~%~%float64[3] x~%float64[3] x_dot~%float64[3] x_2dot~%float64 yaw~%float64 yaw_rate~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DesiredStateMsg)))
  "Returns full string definition for message of type 'DesiredStateMsg"
  (cl:format cl:nil "# DesiredStateMsg~%~%float64[3] x~%float64[3] x_dot~%float64[3] x_2dot~%float64 yaw~%float64 yaw_rate~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <DesiredStateMsg>))
  (cl:+ 0
     ...
     0 (cl:reduce #'cl:+ (cl:slot-value msg 'x_2dot) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 8)))
     8
     8
))
