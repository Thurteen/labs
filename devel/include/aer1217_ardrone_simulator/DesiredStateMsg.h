...
struct DesiredStateMsg_
{
  ...
  _x_dot_type x_dot;
   ...
   typedef boost::array<double, 3>  _x_2dot_type;
  _x_2dot_type x_2dot;
...
// {'aer1217_ardrone_simulator': ['/home/thurteen/aer1217/labs/src/aer1217_ardrone_simulator/msg'], 'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg']}
...
struct MD5Sum< ::aer1217_ardrone_simulator::DesiredStateMsg_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x42fa4626d1775b5bULL;
  static const uint64_t static_value2 = 0xbdc04cda38e22d9cULL;
};
...
struct Printer< ::aer1217_ardrone_simulator::DesiredStateMsg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::aer1217_ardrone_simulator::DesiredStateMsg_<ContainerAllocator>& v)
  {
    ...
    s << indent << "x_2dot[]" << std::endl;
    for (size_t i = 0; i < v.x_2dot.size(); ++i)
    {
      s << indent << "  x_2dot[" << i << "]: ";
      Printer<double>::stream(s, indent + "  ", v.x_2dot[i]);
    }
    s << indent << "yaw: ";
