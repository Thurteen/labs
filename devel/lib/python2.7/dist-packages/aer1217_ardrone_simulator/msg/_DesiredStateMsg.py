...
class DesiredStateMsg(genpy.Message):
  _md5sum = "42fa4626d1775b5bbdc04cda38e22d9c"
  _type = "aer1217_ardrone_simulator/DesiredStateMsg"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# DesiredStateMsg
...
float64 yaw_rate
"""
  __slots__ = ['x','x_dot','x_2dot','yaw','yaw_rate']
  _slot_types = ['float64[3]','float64[3]','float64[3]','float64','float64']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_3d().pack(*self.x_2dot))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.x_2dot = _get_struct_3d().unpack(str[start:end])
      _x = self
      start = end
      end += 16
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(self.x_2dot.tostring())
      _x = self
      buff.write(_get_struct_2d().pack(_x.yaw, _x.yaw_rate))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.x_2dot = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=3)
      _x = self
      start = end
      end += 16
      (_x.yaw, _x.yaw_rate,) = _get_struct_2d().unpack(str[start:end])
