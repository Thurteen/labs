...
set(MSG_I_FLAGS "-Iaer1217_ardrone_vicon:/home/thurteen/aer1217/labs/src/aer1217_ardrone_vicon/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/thurteen/aer1217/labs/src/aer1217_ardrone_vicon/msg/MotorCommands.msg" NAME_WE)
add_custom_target(_aer1217_ardrone_vicon_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "aer1217_ardrone_vicon" "/home/thurteen/aer1217/labs/src/aer1217_ardrone_vicon/msg/MotorCommands.msg" ""
)

get_filename_component(_filename "/home/thurteen/aer1217/labs/src/aer1217_ardrone_vicon/msg/DesiredStateMsg.msg" NAME_WE)
add_custom_target(_aer1217_ardrone_vicon_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "aer1217_ardrone_vicon" "/home/thurteen/aer1217/labs/src/aer1217_ardrone_vicon/msg/DesiredStateMsg.msg" ""
)

get_filename_component(_filename "/home/thurteen/aer1217/labs/src/aer1217_ardrone_vicon/msg/GazeboState.msg" NAME_WE)
add_custom_target(_aer1217_ardrone_vicon_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "aer1217_ardrone_vicon" "/home/thurteen/aer1217/labs/src/aer1217_ardrone_vicon/msg/GazeboState.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/aer1217_ardrone_vicon)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/aer1217_ardrone_vicon\")")
  # install generated code
  install(
